                        ...
                        <table class="table table-bordered rating-table" style="border: 1px solid black;">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($rating){
                                        echo form_input('8_1', set_value('8_1', ($arrRate['8_1'] != 0) ? ltrim($arrRate['8_1'], '0') : 0), 'class="form-control sub" readonly id="8_1"');
                                    }else{
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($rating){
                                        echo form_input('8_2', set_value('8_2', ($arrRate['8_2'] != 0) ? ltrim($arrRate['8_2'], '0') : 0), 'class="form-control sub" readonly id="8_2"');
                                    }else{
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($rating){
                                        echo form_input('8_3', set_value('8_3', ($arrRate['8_3'] != 0) ? ltrim($arrRate['8_3'], '0') : 0), 'class="form-control sub" readonly id="8_3"');
                                    }else{
...
<script>
    $('.sub').change(function(){
        ...
        let main6 = (parseInt($('#6_1').val()) * 0.4 + parseInt($('#6_1').val()) * 0.3 + parseInt($('#6_1').val()) * 0.3) * 0.1;
        $('#6').val(Number(main6.toFixed(2)));

        let main7 = (parseInt($('#7_1').val()) * 0.2 + parseInt($('#7_1').val()) * 0.4 + parseInt($('#7_1').val()) * 0.4) * 0.1;
